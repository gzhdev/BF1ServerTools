...
public static class MapDB
{
    ...
    public class MapInfo
    {
        ...
        {
            return $"\\Assets\\Caches\\Teams\\{Team1Image}.png";
        }

        public string GetTeam2Image()
        {
            return $"\\Assets\\Caches\\Teams\\{Team2Image}.png";
        }

        public string GetMapImage()
        {
            return $"\\Assets\\Caches\\Maps\\{MapImage}";
        }
    }
    ...
    {
        new() { English="ID_M_LEVEL_MENU", Chinese="大厅菜单", Team1="大厅", Team2="大厅", Team1Image="_DEF", Team2Image="_DEF" },
